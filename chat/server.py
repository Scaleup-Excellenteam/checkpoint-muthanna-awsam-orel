    ...
    try:
        ...
        with client_socket.makefile("rb") as stream:
            ...
            while True:
                ...
                url_decision = reputation_checker.check_urls_in_text(message)
                ...
                if url_decision is not None and not url_decision.allowed:
                    logger.warning("event=malicious_url_detected username=%s reason='%s'", username, url_decision.reason)
